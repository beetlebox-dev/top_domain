...
const stapleyHtmlAll = `
    ...
    <ol id="stapley-jokes-list" style="display: none; ">
        {% for joke_lines_list in stapley_jokes %}
            <li>
                {% for joke_line_str in joke_lines_list %}
                    <p>{{ joke_line_str }}</p>
                {% endfor %}
            </li>
        {% endfor %}
    ...
    <!-- //////.////// DEBUG ONLY WRAPPER -->
    <div style="position: fixed; display: flex; top: 0; left: 0; height: 100vh; width: 100vw; z-index: -999; ">
